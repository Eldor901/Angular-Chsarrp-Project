    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngridientCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngridientCategoryId = table.Column<int>(nullable: true),
                    ProductId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingridients_IngridientCategories_IngridientCategoryId",
                        column: x => x.IngridientCategoryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cuisines_UserId",
                table: "Cuisines",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Ingridients_IngridientCategoryId",
                table: "Ingridients",
                column: "IngridientCategoryId");
